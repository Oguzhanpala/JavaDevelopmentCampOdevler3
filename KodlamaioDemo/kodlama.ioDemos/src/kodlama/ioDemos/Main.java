...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		/*-- iki şekildede göstermek istedim. --*/
		...
		Instructor[] instructors = new Instructor[] { instructor1 }; // Burada eğitmenleri diziye atadım.
		/*------------------------------------------------------------*/
		...
		categoryManager.add(new Category(3, "Yazılım "));
